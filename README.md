...
|[Автоматизация отчетности по расчетам с партнерами](https://github.com/gianni090/AB_test)|Через партнеров организации проходит определенный объем операций. Каждый партнер должен уплатить определенную комиссию за предоставление интеграционного решения.|**Python** **Pandas** **API** **RE** **Requests** **Xlsxwriter**|
